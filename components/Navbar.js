    ...
    return (
      ...
      <div className="overflow-y-auto h-screen py-4 px-3 rounded" style={{backgroundColor: '#18181B'}}>
         ...
         <ul className="space-y-2">
            <li>
               <Link href="/" className={`flex items-center p-2 text-base font-normal rounded-lg text-white hoverNavItem ${!open && "justify-center"}`}>
            ...
            <li>
               <Link href="/blog" className={`flex items-center p-2 text-base font-normal rounded-lg text-white hoverNavItem ${!open && "justify-center"}`}>
            ...
            <li>
               <Link href="/bio" className={`flex items-center p-2 text-base font-normal rounded-lg text-white hoverNavItem ${!open && "justify-center"}`}>
            ...
            <li>
               <Link href="/info" className={`flex items-center p-2 text-base font-normal rounded-lg text-white hoverNavItem ${!open && "justify-center"}`}>
            ...
            <li>
               <Link href="/projects" className={`flex items-center p-2 text-base font-normal rounded-lg text-white hoverNavItem ${!open && "justify-center"}`}>
