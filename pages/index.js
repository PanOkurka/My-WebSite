                    ...
                    <div className='centerMain'>
                        ...
                        <div className='ContentMove'>
                            ...
                            <motion.div className='Center' exit={{y: 100, opacity: 0, transition: {duration: 0.6}}} initial={{y: 180, opacity: 0}} animate={{y: 0, opacity: 1, transition: {duration: 0.6, delay: 0.9}}}>
                                ...
                                <a href="https://www.buymeacoffee.com/panokurka" rel="noreferrer" style={{marginTop: '4vh'}} target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-blue.png" alt="Buy Me A Coffee" style={{height: '60px !important',width: '217px !important', marginTop: '2vh', marginLeft: '3vh'}} /></a>
