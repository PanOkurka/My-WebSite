              ...
              <div className='info2'>
                <div className="langs-container">
                    <div className="langs-container-3">
                        ...
                        <motion.p className="skilstext-small" exit={{x: -150, opacity: 0, transition: {duration: 0.6, delay: 0.5}}} initial={{x: 150, opacity: 0}} animate={{x: 0, opacity: 1, transition: {duration: 0.6, delay: .1}}}>HTML, CSS, SCSS, JS, ReactJS, NextJS, Webpack</motion.p>
                        ...
                        <motion.p className="skilstext-small" exit={{x: -150, opacity: 0, transition: {duration: 0.6, delay: 0.4}}} initial={{x: 150, opacity: 0}} animate={{x: 0, opacity: 1, transition: {duration: 0.6, delay: .25}}}>PHP, NodeJS, GoLang and some Java, Redis </motion.p>
                        ...
                        <motion.p className="skilstext-small" exit={{x: -150, opacity: 0, transition: {duration: 0.6, delay: 0.2}}} initial={{x: 150, opacity: 0}} animate={{x: 0, opacity: 1, transition: {duration: 0.6, delay: .37}}}>MySql, MongoDB </motion.p>
                        ...
                        <motion.p className="skilstext-small" exit={{x: -150, opacity: 0, transition: {duration: 0.6}}} initial={{x: 150, opacity: 0}} animate={{x: 0, opacity: 1, transition: {duration: 0.6, delay: .44}}}>NGINX, AWS, Docker</motion.p>
                        <motion.div className="w3-container w3-blue w3-round-xlarge DEVOPS" exit={{y: 150, opacity: 0, transition: {duration: 0.6}}} initial={{y: 150, opacity: 0}} animate={{y: 0, opacity: 1, transition: {duration: 0.6, delay: .44}}}><span className="skills-number6">75%</span></motion.div>
                    </div>
                </div>
            </div>
        </motion.div>
