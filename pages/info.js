              ...
              <div className='info2'>
                <div className="langs-container">
                    <div className="langs-container-3">
                        ...
                        <motion.p className="skilstext-small" exit={{x: -150, opacity: 0, transition: {duration: 0.6, delay: 0.2}}} initial={{x: 150, opacity: 0}} animate={{x: 0, opacity: 1, transition: {duration: 0.6, delay: .37}}}>MySQL, MongoDB, SQLite, Redis </motion.p>
